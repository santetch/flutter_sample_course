...
class AppColors {
  ...
  static const Color primaryElement = Color.fromARGB(255, 131, 6, 110);
  ...
  // main widget third color purple
  static const Color primaryThreeElementText = Color.fromARGB(255, 131, 6, 110);
  // main widget active color darker purple
  static const Color primaryThreeElementActive =
      Color.fromARGB(255, 199, 9, 167);
